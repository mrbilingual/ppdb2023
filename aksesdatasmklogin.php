...
//     echo "<br><br>";
//     echo "<form method='POST' action='aksesdatasmklogin.php'>
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="" method="POST">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Login Akses Data SMK</h5>
...
//     echo "You are already logged in as " . $_SESSION['username'];
//     echo "<br><br>";
//     echo "<form method='POST' action='aksesdatasmklogout.php'>
//             <input type='submit' name='logout' value='Logout'>
//           </form>";
...
if (isset($_POST['submit'])) {
    ...
    // Perform a database query to check the username and password
    $query = "SELECT * FROM adminsmk WHERE username='$username' LIMIT 1";
    $result = mysqli_query($koneksi, $query);
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($password === $storedPassword) {
            ...
            header ("location:aksesdatasmk.php");
            exit();
        }
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Akses Data Login SMK</title>
    <link rel="stylesheet" href="bootstrap-4.0.0-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/style.css">
