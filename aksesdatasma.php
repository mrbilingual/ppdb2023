...
<html>
<head>
	<title>Murid SMA PPDB 2023</title>
...
<body>
	...
	<a class="mb-0 h5"><b>AKSES DATA PPDB 2023 SMA</b></a>
	...
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Murid SMA PPDB 2023</h4>
                  <p class="card-description">
                  <a class="btn btn-success" href="exportsma.php">.xls</a>   
                  </p>
	...
	<table class="table table-light">
		...
		$data = mysqli_query($koneksi,"select * from tblsma");
		$no = 1;
