...
//     echo "<br><br>";
//     echo "<form method='POST' action='aksesdatasmplogin.php'>
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="picture/IndonesiaGlobe.jpg"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="" method="POST">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Login Akses Data SMP</h5>
...
if (isset($_POST['submit'])) {
    ...
    // Perform a database query to check the username and password
    $query = "SELECT * FROM adminsmp WHERE username='$username' LIMIT 1";
    $result = mysqli_query($koneksi, $query);
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($password === $storedPassword) {
            ...
            echo "<br><br>";
            header("Location: aksesdatasmp.php");  
            exit();
        }
    }
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Akses Data Login SMP</title>
    <link rel="stylesheet" href="bootstrap-4.0.0-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="assets/css/style.css">
